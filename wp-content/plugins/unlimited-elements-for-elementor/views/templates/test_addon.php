...
<div class="uc-testaddon-panel">
		...
		<a id="uc_button_testaddon_new" href="<?php echo $urlTestAddonNew?>" class="unite-button-secondary uc-button-cat-sap"><?php esc_html_e("Test Addon New", "unlimited-elements-for-elementor")?></a>
